...
let builderGestureLockInitialized = false;
...
function setupBuilderMobileGestureLock() {
  if (builderGestureLockInitialized) return;
  if (!document.body || !document.body.classList.contains("builder-page")) return;

  builderGestureLockInitialized = true;
